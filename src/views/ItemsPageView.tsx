...
export function ItemsPageView({ locale = 'en' }: { locale?: Locale }) {
  ...
  const sorted = useMemo(
    () =>
      [...items].sort((a, b) =>
        getLocalizedItemName(a, locale).localeCompare(
          getLocalizedItemName(b, locale)
        )
      ),
    [locale]
  );
  ...
  return (
    <div className="container-wide">
      ...
      <p className="mb-2 text-gray-400">
        {t('items.subtitle', { count: sorted.length })}
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                {item.gold != null && (
                  <p className="text-xs font-semibold text-hok-gold">
                    {item.gold} gold
                  </p>
                )}
                {label && (
                  <p className="mt-0.5 text-xs font-medium text-hok-gold/90">
                    {label}
                  </p>
                )}
